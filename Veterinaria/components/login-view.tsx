...
import { Usuario, Perfil_Usuario, Veterinario, Cliente } from '@/lib/types'
import { usuarios, perfiles, veterinarios, clientes } from '@/lib/mock-data'
import { 
...
try {
   ...
   // perfiles.push(newPerfil)
    ...
    if (selectedRoleId === 2) {
      const newVeterinario: Veterinario = {
        ...newUser,
        id_Veterinario: veterinarios.length + 1,
        cedula_prof: parseInt(cedula_prof) || 0,
        direcc_consultorio,
        Especialidad
      }
  ...
  const handleDemoLogin = (role_id: number) => {
    const demoUser = usuarios.find(u => u.role_id === role_id)
    if (demoUser) {
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-1.5">
                      <Label htmlFor="nombre_usuario" className="text-xs">usuario</Label>
                      <Input
                        id="nombre_usuario"
